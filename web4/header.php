...
<?php
function hint($value) {
    echo "<body topmargin=100px><center><a href=\"#\" onclick=\"displayPara('para1', false);\" id=\"para1_hide\" style=\"display:none;\">Hide Hint</a>";
    echo "<a href=\"#\" onclick=\"displayPara('para1', true);\" id=\"para1_show\" style=\"\">Show Hint</a><br><br>";
    echo "<div id=\"para1\" style=\"display:none;\">$value</div></center></body>";
}
?>
